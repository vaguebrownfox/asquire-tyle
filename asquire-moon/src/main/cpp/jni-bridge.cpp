...
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_create(JNIEnv *env, jclass clazz) {
...
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_delete(JNIEnv *env, jclass clazz) {
    if (rengine != nullptr && pengine != nullptr) {
        delete rengine;
        rengine = nullptr;
        delete pengine;
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_setRecOn(JNIEnv *env, jclass clazz,
                                                               jboolean is_rec_on) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_setPlyOn(JNIEnv *env, jclass clazz,
                                                               jboolean is_ply_on) {
    if (rengine != nullptr) {
...
extern "C"
JNIEXPORT void JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_setRecFilePath(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT void JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_setPlyFilePath(JNIEnv *env, jclass clazz,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_isRecOn(JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_isPlyOn(JNIEnv *env, jclass clazz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_native_1setDefaultStreamValues(JNIEnv *env,
                                                                                     jclass clazz,
...
Java_aashi_fiaxco_asquiremoon0x0b_asqengine_AsqEngine_asqPredict(JNIEnv *env, jclass clazz,
