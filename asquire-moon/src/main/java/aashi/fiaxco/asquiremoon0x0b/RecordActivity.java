...
import aashi.fiaxco.asquiremoon0x0b.providestuff.Stimulus;
import aashi.fiaxco.asquiremoon0x0b.providestuff.Timer;
...
public class RecordActivity extends AppCompatActivity implements Timer.MessageConstants {
	...
	private Button mRecordButton, mPlayButton, mNextButton, mDoneButton, mContinueButton;
	private SwitchCompat mAssessSwitch;
	private ProgressBar mAsthmaProgress;
	private LinearLayout mFinalThankLL;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTheme(R.style.Theme_AsquireMoon0x0B);
		...
		// Find View
		{
			...
			mFinalThankLL = findViewById(R.id.record_final_thankYou_ll);
			mDoneButton = findViewById(R.id.button_final_done);
			mContinueButton = findViewById(R.id.button_final_continue);
		}
...
//					doPredict();
	...
	private void setOnClickListeners() {
		...
		mCloseButton.setOnClickListener(view -> {
			mFinalThankLL.setVisibility(View.VISIBLE);
		});

		mContinueButton.setOnClickListener(view -> mFinalThankLL.setVisibility(View.GONE));
